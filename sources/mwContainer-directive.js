(function() {
'use strict';
angular.module('mw.validation').directive('mwContainer', ['$parse', '$timeout', function ($parse, $timeout) {
                ...
                compile: function (element, attrs, transclude) {
                    ...
                    return function(scope, elm, attr, ctrl) {
                        ...
                        if (attr.mwContainer) {
                            ...
                            var watchString = attr.mwContainer;
                            if (watchString) {
                                ...
                                var watchFunction = function ($scope) {
                                    ...
                                    var value = $scope.$eval(attr.mwContainer);
                                    var result = '';
                                    if (value) {
                                        var l = value.length;
